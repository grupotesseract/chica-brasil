        ...
        <div class="minicart-content">
            <div class="minicart-content-inner">
                <h3 class="minicart-title">
					<?php echo esc_html__( 'Your Cart', 'ciloe' ); ?>
                </h3>
                                ...
                                <li class="product-cart">
                                    ...
                                    <div class="product-detail">
                                        ...
                                        <div class="product-detail-info">
                                            <span class="product-quantity"><?php printf( esc_html__( 'QTY : %1$s', 'ciloe' ), $cart_item['quantity'] ); ?></span>
                ...
                <div class="actions">
                    <a class="button button-viewcart" href="<?php echo esc_url( wc_get_cart_url() ); ?>">
                        <span><?php esc_html_e( 'View Cart', 'ciloe' ); ?></span>
                    </a>
            ...
            <div class="minicart-content-inner">
                ...
                <div class="minicart-list-items">
                    <div class="empty-wrap">
                        <div class="empty-title"><?php esc_html_e( 'No products in the cart.', 'ciloe' ); ?></div>
                        <a href="<?php echo esc_url( apply_filters( 'woocommerce_return_to_shop_redirect', wc_get_page_permalink( 'shop' ) ) ); ?>"
                           class="to-cart"><?php esc_html_e( 'Start shopping', 'ciloe' ); ?></a>
                    </div>
                </div>
                <div class="des-cart"><a
                            href="/faqs"><?php esc_html_e( 'Our Shipping & Return Policy', 'ciloe' ); ?></a></div>
            </div>
        </div>
	<?php endif; ?>
</div>
