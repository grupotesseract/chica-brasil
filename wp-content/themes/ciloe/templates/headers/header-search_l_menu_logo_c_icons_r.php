<?php
/*
 Name:  Header Search Left - Menu, Logo Center - Icons Right
 */
...
?>
<header id="header"
        class="site-header header header-s_l-lg_m-mm_c-ic_r s_l lg_m mm_c ic_r <?php echo esc_attr( $header_class ); ?>">
        ...
        <div class="header-wrap-stick">
            <div class="header-position" style="background-color: <?php echo esc_attr( $header_bg_color ); ?>;">
                <div class="header-container">
                    ...
                    <div class="row">
                        <div class="header-search col-md-3 col-sm-5">
                        ...
                        <div class="header-logo col-md-6 col-sm-2">
                            <div class="logo">
								<?php ciloe_get_logo(); ?>
                            </div>
                                ...
                                <nav class="main-navigation">
                                    <div class="main-menu">
										...
										wp_nav_menu( array(
											             ...
											             'container_class' => '',
											             'container_id'    => '',
											             'menu_class'      => 'double-menu clone-main-menu ciloe-nav main-menu',
                        ...
                        <div class="header-control-right col-md-3 col-sm-5">
