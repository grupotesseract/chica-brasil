<?php
/*
 Name:  Header Logo Left - Menu Center - Icons Right
 */
...
?>
<header id="header"
        class="site-header header header-lg_l-mn_c-ic_r lg_l mn_c ic_r <?php echo esc_attr( $header_class ); ?> <?php echo esc_attr( $class_shadow ); ?> ">
