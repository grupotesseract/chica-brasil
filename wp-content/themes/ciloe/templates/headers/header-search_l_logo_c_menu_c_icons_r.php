<?php
/*
 Name:  Header Search Left - Logo Center - Menu Center - Icons Right
 */
...
?>
<header id="header"
        class="site-header header header-s_l-lg_c-mm_c-ic_r s_l lg_c mm_c ic_r <?php echo esc_attr( $header_class ); ?>">
